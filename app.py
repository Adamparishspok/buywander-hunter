...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        ...
        st.text_input(
            "Please enter the password to access BuyWander Hunter",
            type="password",
...
if check_password():
    ...
    with st.sidebar:
        ...
        st.markdown("### About")
        st.markdown(
            "Scrapes BuyWander for specific interests: Networking, Benz parts, Tools, etc."
        )
        ...
        try:
            ...
            if selected_categories:
                filtered_df = filtered_df[
                    filtered_df["Interest Category"].isin(selected_categories)
                ]
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "URL": st.column_config.LinkColumn(
                        "Link", display_text="View Auction"
                    ),
